<?php 
   ...
   #SELECT `id`, `id_emprestimo`, `id_obra`, `usuario`, `hora_data_emprestimo`, `hora_data_devolucao`, `devolucao` FROM `tbemprestimo`
                        ...
                        <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                           <thead>
                              <tr role="row">
                                 ...
                                 <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 197.75px;" aria-label="Position: activate to sort column ascending">Obra</th>
                                 <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 92.75px;" aria-label="Office: activate to sort column ascending">Usuário</th>
                                 <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 32.75px;" aria-label="Age: activate to sort column ascending">Emprestado em:</th>
                                 <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 32.75px;" aria-label="Age: activate to sort column ascending">Entregue em:</th>
                                 <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 75.75px;" aria-label="Start date: activate to sort column ascending">Devolvido ?</th>                                 
                              </tr>
                           </thead>
                           <tbody>
