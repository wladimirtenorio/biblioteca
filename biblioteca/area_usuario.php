                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card-counter success">
                            ...
                            <span class="count-numbers">
                                <?php
                                $sql_devolucao = "SELECT * FROM tbemprestimo WHERE usuario ='$id_usuario' AND devolucao = 0";
                    ...
                    <div class="col-md-3">
                        <div class="card-counter danger">
                            ...
                            <span class="count-numbers">
                                 <?php
                                $sql_devolucao = "SELECT * FROM tbemprestimo WHERE usuario ='$id_usuario' AND devolucao = 1";
                                if ($resultado_devolucao = mysqli_query($conexao, $sql_devolucao)) {
                                    $contar_linhas = mysqli_num_rows($resultado_devolucao);
                                    printf($contar_linhas);
                                } else {
